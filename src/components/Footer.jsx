            ...
            <div className="max-w-[85%] mx-auto py-8">
                <div className="row text-center text-md-start">
                    ...
                    <div className="col-md-4 mb-6 mb-md-0">
                        <h2 className="text-sm font-bold mb-3 tracking-widest text-muted uppercase">Let's Connect 🌐</h2>
                        ...
                        <div className="d-flex flex-column gap-2">
                            ...
                            >
                                <BiCurrentLocation size={22}
                                                   className="transition-transform duration-1000 group-hover:rotate-[360deg]"></BiCurrentLocation>
                                <span className="text-gray-900">Madhubani, Bihar</span>
                            </a>
                            ...
                            >
                                <BiLogoGmail
                                    ...
                                    size={22}/>
                                <span className="text-gray-900">manishrajrnl@zohomail.in</span>
                            </a>
                            ...
                            >
                                ...
                                <span className="text-gray-900">+91 9501421887</span>
                            </a>

                            <a
                                href={ResumeLink}
                                target="_blank"
                                className="group text-gray-700 text-sm text-decoration-none d-inline-flex align-items-center gap-x-2 transition-all hover:translate-x-1 hover:-translate-y-1"
                            >
                                <BiLogoAdobe size={22}
                                             className="text-red-900 transition-transform duration-700 group-hover:rotate-[360deg]"></BiLogoAdobe>
                                <span className="text-gray-800">Request My Resume</span>
                            </a>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div
                            className="d-flex flex-wrap justify-content-center justify-content-md-start gap-3 pt-4">
                                ...
                                <a key={i} href={social.href} target="_blank" rel="noreferrer"
                                   className={`group d-flex align-items-center gap-2 px-3 py-1.5 rounded-full border ${social.border} text-decoration-none ${social.text || 'text-dark'} ${social.bg} ${social.hover || ''} shadow-sm hover:shadow-md hover:-translate-y-1 hover:translate-x-1 transition-all`}>
                                    <social.icon
                                        ...
                                        size={16} color={social.color}/>
                                    <span className="fw-bold" style={{ fontSize: '11px' }}>{social.label}</span>
                                </a>
                            ))}
                        </div>
                    </motion.div>
                ...
                <div className="text-center text-gray-950">
                    ...
                    <p className="mb-0 font-medium" style={{ fontSize: '12px' }}>
                        Designed with ❤️ by <strong className="text-yellow-700">Manish</strong>
                    </p>
                </div>
            </div>
        </footer>
