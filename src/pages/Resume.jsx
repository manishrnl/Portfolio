...
const Resume = () => {
    ...
    const previewOverlayStyle = {
        ...
        background:
            "linear-gradient(to bottom, rgba(30, 30, 30, 0) 0%, rgba(30, 30, 30, 1) 100%)",
        pointerEvents: "none",
    };

    return (
        <section
            className="resume-page py-5"
                ...
                <div className="row justify-content-center">
                    ...
                    <div className="col-12 mb-5">
                        ...
                        >
                            ...
                            <p
                                className="lead"
                                style={{ fontSize: "1.2rem", color: "#bbb" }}
                            >
                                Software Development Engineer aspirant
                                specializing in scalable Microservices and
                                AI-driven backend systems using Java and Spring
                                Boot. Proficient in architecting distributed
                                platforms with Docker, Kubernetes, and Kafka to
                            ...
                            <div className="mb-4">
                                ...
                                <ul style={{ color: "#bbb" }}>
                                    <li>
                                        Architected using Java, Spring Boot, and
                                        Microservices.
                                    </li>
                                    <li>
                                        Optimized connection query performance
                                        by 40% using Neo4j.
                                    </li>
                                </ul>
                            </div>
